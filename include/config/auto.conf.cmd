deps_config := \
	...
	drivers/net/wireless/aic8800_sdio/aic8800_btlpm/Kconfig \
	drivers/net/wireless/aic8800_sdio/aic8800_fdrv/Kconfig \
	drivers/net/wireless/aic8800_sdio/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.1.75"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/toolchains/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/toolchains/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
...
ifneq "$(NM)" "/toolchains/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/toolchains/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "/toolchains/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
